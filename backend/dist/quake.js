...
export const getObject = (value, key) => {
...
export const getString = (value, key) => {
...
export const getNumber = (value, key) => {
...
export const parseP2PTime = (value) => {
...
export const nullableNumber = (value) => (value < 0 ? null : value);
export const parseQuake = (value) => {
    if (!isObject(value)) {
...
export const extractPublisher = (raw) => {
    if (!isObject(raw)) {
        return null;
    }
