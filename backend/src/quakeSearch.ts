import type { SortOption } from './shared.js'

export type QuakeSearchParams = {
  place: string
  datetime: string
...
export const parseSortOption = (value: string | undefined): SortOption => {
  switch (value) {
    case 'time-asc':
    case 'time-desc':
    case 'magnitude-asc':
...
export const parseQuakeSearchParams = (
...
export const buildOrderByClause = (sortBy: SortOption): string => {
  switch (sortBy) {
    case 'time-asc':
